...
### [P01](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P01Test.java) **(*) Find the last element of a list**
...
### [P02](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P02.java) **(*) Find the last but one element of a list**
...
### [P03](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P03.java) **(*) Find the Kth element of a list**
...
### [P04](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P04.java) **(*) Find the number of elements of a list**
...
### [P05](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P05.java) **(*) Reverse a list**
...
### [P06](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P06.java) **(*) Find out whether a list is a palindrome**
...
### [P07](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P07.java) **(\*\*) Flatten a nested list structure**
...
### [P08](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P08.java) **(\*\*) Eliminate consecutive duplicates of list elements**
...
### [P09](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P09.java) **(\*\*) Pack consecutive duplicates of list elements into sublists**
...
### [P10](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P10.java) **(*) Run-length encoding of a list**
...
### [P11](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P11.java) **(*) Modified run-length encoding**
...
### [P12](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P12.java) **(\*\*) Decode a run-length encoded list**
...
### [P13](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P13.java) **(\*\*) Run-length encoding of a list (direct solution)**
...
### [P14](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P14.java) **(*) Duplicate the elements of a list**
...
### [P15](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P15.java) ** (\*\*) Duplicate the elements of a list a given number of times**
...
### [P16](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P16.java) **(\*\*) Drop every N'th element from a list**
...
### [P17](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P17.java) **(*) Split a list into two parts; the length of the first part is given**
...
### [P18](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P18.java) **(\*\*) Extract a slice from a list**
...
### [P19](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P19.java) **(\*\*) Rotate a list N places to the left**
...
### [P20](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P20.java) **(*) Remove the K'th element from a list**
...
### [P21](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P21.java) **(*) Insert an element at a given position into a list**
...
### [P22](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P22.java) **(*) Create a list containing all integers within a given range**
...
### [P23](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P23.java) **(\*\*) Extract a given number of randomly selected elements from a list**
...
### [P24](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P24.java) **(*) Lotto: Draw N different random numbers from the set 1..M**
...
### [P25](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P25.java) **(*) Generate a random permutation of the elements of a list**
...
### [P26](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P26.java) **(\*\*) Generate the combinations of K distinct objects chosen from the N elements of a list**
...
### [P27](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P27.java) **(\*\*) Group the elements of a set into disjoint subsets**
...
### [P28](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/prologLists/P28.java) **(\*\*) Sorting a list of lists according to length of sublists**
...
### [P31](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P31.java) **(\*\*) Determine whether a given integer number is prime.**
...
### [P32](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P32.java) **(\*\*) Determine the prime factors of a given positive integer.**
...
### [P33](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P33.java) **(\*\*) Determine the prime factors of a given positive integer (2).**
...
### [P34](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P34.java) **(*) A list of prime numbers**
...
### [P35](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P35.java) **(\*\*)  Goldbach's conjecture.**
...
### [P36](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P36.java) **(\*\*)  A list of Goldbach compositions.**
...
### [P37](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P37.java) **(\*\*)  Determine the greatest common divisor of two positive integer numbers.**
...
### [P38](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P38.java) **(*)  Determine whether two positive integer numbers are coprime.**
...
### [P39](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P39.java) **(\*\*)  Calculate Euler's totient function phi(m).**
...
### [P40](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P40.java) **(\*\*)  Calculate Euler's totient function phi(m) (2).**
...
### [P41](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/arithmetic/P41Test.java) **(*)  Compare the two methods of calculating Euler's totient function.**
...
### [P46](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/LogicAndCodes/P46Test.java) **(\*\*)  Truth tables for logical expressions.**
...
### [P47](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/LogicAndCodes/P47Test.java) **(*)  Truth tables for logical expressions (2).**

Skipping this problem for now.

### [P48](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/LogicAndCodes/P48Test.java) **(\*\*)  Truth tables for logical expressions (3).**

Skipping this problem for now.


### [P49](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/LogicAndCodes/P49Test.java) **(\*\*)  Gray code.**
...
### [P50](https://github.com/www1350/99-problems/blob/master/src/test/java/com/absurd/np/LogicAndCodes/P50Test.java) **(\*\*)  huffman.**
